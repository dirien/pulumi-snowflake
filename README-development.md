...
1. Run the following command to update files to use the name of your provider (third-party: use your GitHub organization/username):
   ...
   - find and replace all instances of the boilerplate `snowflake` with the `NAME` of your provider.
...
- binary: pulumi-resource-snowflake
  ...
  ignore: []
  ldflags:
  - -X github.com/dirien/pulumi-snowflake/provider/pkg/version.Version={{.Tag}}
...
├── config.yaml
├── metadata.json
├── pulumi-snowflake_darwin_amd64_v1
│   └── pulumi-resource-snowflake
├── pulumi-snowflake_darwin_arm64
│   └── pulumi-resource-snowflake
├── pulumi-snowflake_linux_amd64_v1
│   └── pulumi-resource-snowflake
├── pulumi-snowflake_linux_arm64
│   └── pulumi-resource-snowflake
├── pulumi-snowflake_windows_amd64_v1
│   └── pulumi-resource-snowflake.exe
└── pulumi-snowflake_windows_arm64
    └── pulumi-resource-snowflake.exe
```
