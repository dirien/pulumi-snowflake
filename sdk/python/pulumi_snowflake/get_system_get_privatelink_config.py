...
__all__ = [
    ...
    'get_system_get_privatelink_config',
]
...
def get_system_get_privatelink_config(opts: Optional[pulumi.InvokeOptions] = None) -> AwaitableGetSystemGetPrivatelinkConfigResult:
    """
