	...
	prov := tfbridge.ProviderInfo{
		...
		Resources: map[string]*tfbridge.ResourceInfo{
			...
			"snowflake_external_oauth_integration": {
				Tok: tfbridge.MakeResource(mainPkg, mainMod, "ExternalOauthIntegration"),
			},
			...
			"snowflake_network_policy_attachment": {
				Tok: tfbridge.MakeResource(mainPkg, mainMod, "NetworkPolicyAttachment"),
			},
			"snowflake_notification_integration": {
				Tok: tfbridge.MakeResource(mainPkg, mainMod, "NotificationIntegration"),
			},
			...
			"snowflake_tag_masking_policy_association": {
				Tok: tfbridge.MakeResource(mainPkg, mainMod, "TagMaskingPolicyAssociation"),
			},
		...
		DataSources: map[string]*tfbridge.DataSourceInfo{
			...
			"snowflake_external_functions": {
				Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getExternalFunctions"),
			},
			"snowflake_external_tables": {
				Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getExternalTables"),
			},
			...
			"snowflake_masking_policies": {
				Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getMaskingPolicies"),
			},
			"snowflake_materialized_views": {
				Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getMaterializedViews"),
			},
			...
			"snowflake_resource_monitors": {
				Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getResourceMonitors"),
			},
			...
			"snowflake_row_access_policies": {
				Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getRowAccessPolicies"),
			},
			...
			"snowflake_storage_integrations": {
				Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getStorageIntegrations"),
			},
			"snowflake_streams": {Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getStreams")},
			"snowflake_system_generate_scim_access_token": {
				Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getSystemGenerateScimAccessToken"),
			},
			"snowflake_system_get_aws_sns_iam_policy": {
				Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getSystemGetAwsSnsIamPolicy"),
			},
			...
			"snowflake_system_get_snowflake_platform_info": {
				Tok: tfbridge.MakeDataSource(mainPkg, mainMod, "getSystemGetSnowflakePlatformInfo"),
			},
